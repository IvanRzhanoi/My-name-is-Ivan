...
class ProjectsTableViewController: UITableViewController {
    ...
    private func loadProjects() {
        let project1 = Project(name: "MusicMood", image: #imageLiteral(resourceName: "MusicMood"), description: "A unique application to play music depdnding on user's feelingsLater will be integrated in hospitals to ease doctors’ work.An online-based service with mobile apps that helps patients rehabilitate. Later will be integrated in hospitals to ease doctors’ work.An online-based service with mobile apps that helps patients rehabilitate. Later will be integrated in hospitals to ease doctors’ work.An online-based service with mobile apps that helps patients rehabilitate. Later will be integrated in hospitals to ease doctors’ work.Later will be integrated in hospitals to ease doctors’ work.An online-based service with mobile apps that helps patients rehabilitate. Later will be integrated in hospitals to ease doctors’ work.An online-based service with mobile apps that helps patients rehabilitate. Later will be integrated in hospitals to ease doctors’ work.An online-based service with mobile apps that helps patients rehabilitate. Later will be integrated in hospitals to ease doctors’ work.Later will be integrated in hospitals to ease doctors’ work.An online-based service with mobile apps that helps patients rehabilitate. Later will be integrated in hospitals to ease doctors’ work.An online-based service with mobile apps that helps patients rehabilitate. Later will be integrated in hospitals to ease doctors’ work.An online-based service with mobile apps that helps patients rehabilitate. Later will be integrated in hospitals to ease doctors’ work.") // else { fatalError("Unable to load") }
