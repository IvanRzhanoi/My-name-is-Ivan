...
class ProjectsTableViewController: UITableViewController {
    ...
    private func loadProjects() {
        ...
        let project3 = Project(name: "Untitled game", image: #imageLiteral(resourceName: "Game"), description: "For more information on project please check\n\nhttp://urn.fi/URN:NBN:fi:amk-2018060512587")
        let project4 = Project(name: "Q-project", image: #imageLiteral(resourceName: "Qproject"), description: "For more information on project please check\n\nhttp://urn.fi/URN:NBN:fi:amk-2018060512587")
        let project5 = Project(name: "MariVision", image: #imageLiteral(resourceName: "MariVision"), description: "For more information on project please check\n\nhttp://urn.fi/URN:NBN:fi:amk-2018060512587")
        let project6 = Project(name: "Car renting service", image: #imageLiteral(resourceName: "PRC"), description: "I didn't finish explaining all the projects I have done. Please be patient...")
        let project7 = Project(name: "Bicycle Renting Service Concept", image: #imageLiteral(resourceName: "BicycleRent"), description: "I didn't finish explaining all the projects I have done. Please be patient...")
